...
def newlon(windspeed,bearing,lat,lon):
    R = 6378.1 #Radius of the Earth
    if bearing >= 180:
        brng = math.radians(bearing-180) #Bearing is 90 degrees converted to radians.
    else:
        brng = math.radians(bearing+180) #Bearing is 90 degrees converted
...
startlatitude=70.82    #degrees north
startlongitude=147.49      #degrees west
#number of runs
Number = 100
#afwijking
afwijking = 0.1
...
afwijkingarray = [1]
afwijkingarray[1:] = np.random.normal(1,afwijking,Number)
            ...
            if t < datalens[1]+datalens[0]:
                ...
                if t < datalens[2]+datalens[1]+datalens[0]:
                    ...
                    if t < datalens[3]+datalens[2]+datalens[1]+datalens[0]:
                        ...
                        new_t=t-datalens[0]-datalens[1]-datalens[2]
        lat=latitude[-1]
        lon=longitude[-1]
